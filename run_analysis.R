...
##############################################################################
# PREANALYSIS 1 - Get data
##############################################################################

# download zip file containing data if not yet downloaded
...
# linking separate data tables to make single data table
humanActivity <- rbind(
...
humanActivityCols <- gsub("^freq", "frequencyDomain", humanActivityCols)
humanActivityCols <- gsub("^ti", "timeDomain", humanActivityCols)
humanActivityCols <- gsub("Acc", "Accelerometer", humanActivityCols)
humanActivityCols <- gsub("Gyro", "Gyroscope", humanActivityCols)
humanActivityCols <- gsub("Magn", "Magnitude", humanActivityCols)
...
humanActivityMeans <- humanActivity %>% 
  ...
  #summarise(across(humanActivityCols, mean))
